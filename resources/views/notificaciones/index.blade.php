        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="p-5 border border-gray-200 rounded-lg my-3 lg:flex lg:justify-between lg:items-center">
                        <div class="">
                        ...
                        <div class="mt-5 lg:mt-0 text-center">
                            <a href="#" class="bg-indigo-500 rounded-xl p-3 text-white text-sm uppercase font-bold">Ver Candidatos</a>
                        </div>
                    </div>
                    @empty
