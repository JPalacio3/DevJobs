        ...
        <div>
            ...
            <div>
                <p class="text-sm mt-2 text-red-800">
                    {{ __('Tu dirección de Email Necesita ser verificada.') }}

                    <button form="send-verification" class="underline text-sm text-indigo-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        {{ __('Has click aquí para enviar el Email de verificación.') }}
                    </button>
                </p>
